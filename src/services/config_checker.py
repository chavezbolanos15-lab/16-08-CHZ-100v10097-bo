...
# -*- coding: utf-8 -*-
"""
ARQV30 Enhanced v2.0 - Config Checker
Verificador de configuração de APIs e serviços
"""
        ...
        for category, apis in self.required_apis.items():
            ...
            for api_key in apis:
                ...
                if os.getenv(api_key):
                    ...
                    if api_key in ['GEMINI_API_KEY', 'GOOGLE_SEARCH_KEY', 'SUPABASE_URL']:
...
# Instância global
api_config_checker = APIConfigChecker()